...
import { updateCourse, deleteCourse } from '../store/slices/courseSlice';
import { X, Save, Calendar, User, BookOpen, Tag, Image, FileText, Trash2 } from 'lucide-react';
...
const EditCourseForm: React.FC<EditCourseFormProps> = ({ courseId, onClose }) => {
